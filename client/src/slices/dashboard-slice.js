...
export const addCard = createAsyncThunk("dashboard/create", async(parameter)=>{
    ...
    const {data} = await axios.post("http://13.61.194.165:8080/task/create", {...parameter},{
        headers: {
...
export const getAllCards = createAsyncThunk("dashboard/getAll", async()=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.post("http://13.61.194.165:8080/task/get",{},{
        headers: {
          "Content-Type": "application/json"
        }
      })
...
export const updateCard = createAsyncThunk("dashboard/update", async(params)=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.post("http://13.61.194.165:8080/task/edit", params,{
        headers: {
          "Content-Type": "application/json"
        }
      })
...
export const deleteCard = createAsyncThunk("dashboard/delete", async(cardId)=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.delete("http://13.61.194.165:8080/task/delete",{ data:{cardId}},{
        headers: {
          "Content-Type": "application/json"
        }
      })

...
export const addCard = createAsyncThunk("dashboard/create", async(parameter)=>{
    ...
    const {data} = await axios.post("https://rico-handhelds-tough-mart.trycloudflare.com/task/create", {...parameter},{
        headers: {
...
export const getAllCards = createAsyncThunk("dashboard/getAll", async()=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.post("https://rico-handhelds-tough-mart.trycloudflare.com/task/get",{},{
        headers: {
          "Content-Type": "application/json"
        }
      })
...
export const updateCard = createAsyncThunk("dashboard/update", async(params)=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.post("https://rico-handhelds-tough-mart.trycloudflare.com/task/edit", params,{
        headers: {
          "Content-Type": "application/json"
        }
      })
...
export const deleteCard = createAsyncThunk("dashboard/delete", async(cardId)=>{
    axios.defaults.withCredentials=true
    const {data} = await axios.delete("https://rico-handhelds-tough-mart.trycloudflare.com/task/delete",{ data:{cardId}},{
        headers: {
          "Content-Type": "application/json"
        }
      })
